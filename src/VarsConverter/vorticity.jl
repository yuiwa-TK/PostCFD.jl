...
"""
    vorticity_4thcentral_linearmesh(v::Matrix{<:AbstractFloat},w::Matrix{<:AbstractFloat},y::Vector{<:AbstractFloat},z::Vector{<:AbstractFloat}) where <:AbstractFloat
...
"""
function vorticity_4thcentral_linearmesh(v::Matrix{<:AbstractFloat}, w::Matrix{<:AbstractFloat}, y::Vector{<:AbstractFloat}, z::Vector{<:AbstractFloat}) where <:AbstractFloat
    kmax = length(y)
    lmax = length(z)
